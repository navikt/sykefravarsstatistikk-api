...
public class EksporteringServiceTestUtils {
  ...
  public static SykefraværsstatistikkNæring5Siffer byggSykefraværStatistikkNæring5Siffer(
      ÅrstallOgKvartal statistikkÅrstallOgKvartal,
      String næringskode5Siffer) {
    return new SykefraværsstatistikkNæring5Siffer(
        statistikkÅrstallOgKvartal.getÅrstall(),
        statistikkÅrstallOgKvartal.getKvartal(),
  ...
  public static List<SykefraværsstatistikkVirksomhetUtenVarighet> byggVirksomhetSykefraværUtenVarighet(
    ...
    return årstallOgKvartaler.stream().map(
        vv -> new SykefraværsstatistikkVirksomhetUtenVarighet(vv.getÅrstall(), vv.getKvartal(),
            virksomhetMetadata.getOrgnr(), 10, new BigDecimal(15), new BigDecimal(1000)
  ...
  public static void assertEqualsSykefraværOverFlereKvartaler(
    ...
    assertThat(actual.getKvartaler()).as("Sjekk listen av kvartaler")
  ...
  public static void assertEqualsVirksomhetSykefravær(VirksomhetSykefravær expected,
      VirksomhetSykefravær actual) {
  ...
  public static void assertEqualsSykefraværMedKategori(
    ...
    assertThat(actual.getKategori()).as("Sjekk Statistikkategori")
  ...
  public static void assertEqualsStatistikkDto(
    ...
    assertThat(actual.getStatistikkategori()).as("Sjekk Statistikkategori")
        .isEqualTo(expected.getStatistikkategori());
    assertThat(actual.getLabel()).as("Sjekk label").isEqualTo(expected.getLabel());
    assertThat(actual.getKvartalerIBeregningen()).as("Sjekk kvartaler i beregningen")
    ...
    assertThat(actual.getAntallPersonerIBeregningen()).as("Sjekk antall personer")
  ...
  public static void assertKafkaTopicValueEquals(KafkaTopicValue expected, KafkaTopicValue actual) {
    ...
    assertEqualsVirksomhetSykefravær(actual.getVirksomhetSykefravær(),
        expected.getVirksomhetSykefravær());
  }
  ...
  public static void assertKafkaStatistikkKategoriTopicValueEquals(
    ...
    assertSistePubliserteKvartalEquals(expected.getSistePubliserteKvartal(),
        actual.getSistePubliserteKvartal());
    assertSiste4KvartalerEquals(expected.getSiste4Kvartal(), actual.getSiste4Kvartal());
  }

  private static void assertSiste4KvartalerEquals(Siste4Kvartaler expected,
      Siste4Kvartaler actual) {
