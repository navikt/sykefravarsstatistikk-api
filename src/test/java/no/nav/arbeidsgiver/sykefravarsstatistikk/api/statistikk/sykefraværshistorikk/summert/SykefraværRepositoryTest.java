...
public class SykefraværRepositoryTest {
    ...
    @Test
    public void sorterKronologisk__sorterer_til_ny_liste_uavhengig_av_antall_elementer_som_skal_sorteres() {
        ...
        assertThat(sorterKronologisk(List.of(SF_Q1_2022, SF_Q4_2021))).isEqualTo(List.of(SF_Q4_2021, SF_Q1_2022));
    }
