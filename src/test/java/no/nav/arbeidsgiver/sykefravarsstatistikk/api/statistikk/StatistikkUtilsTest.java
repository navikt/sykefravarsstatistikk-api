...
class StatistikkUtilsTest {
  ...
  public void kalkulerSykefraværsprosent_girÉnDesimalISvaret() {
    ...
    assertThat(kalkulerSykefraværsprosent(BigDecimal.ONE, new BigDecimal("1.00")).get())
        .isEqualTo(new BigDecimal("100.0"));
  ...
  public void kalkulerSykefraværsprosent_regnerUtKorrektProsent() {
    assertThat(kalkulerSykefraværsprosent(new BigDecimal("5"), new BigDecimal("10")).get())
        .isEqualTo(new BigDecimal("50.0"));

    assertThat(kalkulerSykefraværsprosent(BigDecimal.ZERO, new BigDecimal("100.00")).get())
        .isEqualTo(new BigDecimal("0.0"));

    assertThat(kalkulerSykefraværsprosent(new BigDecimal("0.01"), new BigDecimal("1000")).get())
        .isEqualTo(new BigDecimal("0.0"));

    assertThat(kalkulerSykefraværsprosent(new BigDecimal("1.01"), new BigDecimal("1.02")).get())
  ...
  public void kalkulerSykefraværsprosent_runderOppKorrekt() {
    assertThat(kalkulerSykefraværsprosent(new BigDecimal("0.55"), BigDecimal.ONE).get())
        .isEqualTo(new BigDecimal("55.0"));

    assertThat(kalkulerSykefraværsprosent(new BigDecimal("0.555"), BigDecimal.ONE).get())
        .isEqualTo(new BigDecimal("55.5"));

    assertThat(kalkulerSykefraværsprosent(new BigDecimal("0.5555"), BigDecimal.ONE).get())
        .isEqualTo(new BigDecimal("55.6"));

    assertThat(kalkulerSykefraværsprosent(new BigDecimal("0.05"), BigDecimal.ONE).get())
        .isEqualTo(new BigDecimal("5.0"));

    assertThat(kalkulerSykefraværsprosent(new BigDecimal("0.005"), BigDecimal.ONE).get())
        .isEqualTo(new BigDecimal("0.5"));

    assertThat(kalkulerSykefraværsprosent(new BigDecimal("0.0005"), BigDecimal.ONE).get())
  ...
  public void kalkulerSykefraværsprosent_runderNedKorrekt() {
    assertThat(kalkulerSykefraværsprosent(new BigDecimal("0.44"), BigDecimal.ONE).get())
        .isEqualTo(new BigDecimal("44.0"));

    assertThat(kalkulerSykefraværsprosent(new BigDecimal("0.444"), BigDecimal.ONE).get())
        .isEqualTo(new BigDecimal("44.4"));

    assertThat(kalkulerSykefraværsprosent(new BigDecimal("0.4444"), BigDecimal.ONE).get())
        .isEqualTo(new BigDecimal("44.4"));

    assertThat(kalkulerSykefraværsprosent(new BigDecimal("0.04"), BigDecimal.ONE).get())
        .isEqualTo(new BigDecimal("4.0"));

    assertThat(kalkulerSykefraværsprosent(new BigDecimal("0.004"), BigDecimal.ONE).get())
        .isEqualTo(new BigDecimal("0.4"));

    assertThat(kalkulerSykefraværsprosent(new BigDecimal("0.0004"), BigDecimal.ONE).get())
        .isEqualTo(new BigDecimal("0.0"));
  }
}