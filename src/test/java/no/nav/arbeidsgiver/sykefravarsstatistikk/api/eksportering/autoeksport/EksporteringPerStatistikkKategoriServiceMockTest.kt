...
public class EksporteringPerStatistikkKategoriServiceMockTest {
  ...
  @Captor ArgumentCaptor<Statistikkategori> statistikkategoriArgumentCaptor;
  @Captor ArgumentCaptor<String> identifikatorArgumentCaptor;
  @Captor ArgumentCaptor<SykefraværMedKategori> sykefraværMedKategoriArgumentCaptor;

  @Captor
  ArgumentCaptor<SykefraværFlereKvartalerForEksport>
      sykefraværFlereKvartalerForEksportArgumentCaptor;

  @BeforeEach
  public void setUp() {
    service =
        new EksporteringPerStatistikkKategoriService(
  ...
  @Test
  public void
      eksporterSykefraværsstatistikkLand__sender_riktig_melding_til_kafka_og_returnerer_antall_meldinger_sendt() {
    ...
    when(kafkaService.sendTilStatistikkKategoriTopic(any(), any(), any(), any(), any()))
        .thenReturn(true);
    ...
    EksporteringServiceTestUtils.assertEqualsSykefraværMedKategori(
        landSykefravær, sykefraværMedKategoriArgumentCaptor.getValue());
  ...
  @Test
  public void
      eksporterSykefraværsstatistikkVirksomhet__sender_riktig_melding_til_kafka_og_returnerer_antall_meldinger_sendt() {
    // 1- Mock det database og repositories returnerer. Samme med KafkaService
    List<SykefraværsstatistikkVirksomhetUtenVarighet> allData =
        List.of(
    ...
    when(sykefraværsstatistikkTilEksporteringRepository.hentSykefraværAlleVirksomheter(
            __2019_3, __2020_2))
        .thenReturn(allData);
    when(kafkaService.sendTilStatistikkKategoriTopic(any(), any(), any(), any(), any()))
        .thenReturn(true);
        ...
        .thenReturn(
            Arrays.asList(
                new VirksomhetEksportPerKvartal(
                    new Orgnr("987654321"), new ÅrstallOgKvartal(2022, 2), false)));

    // 2- Kall tjenesten
    int antallEksporterte =
        service.eksporterSykefraværsstatistikkVirksomhet(
            __2020_2, EksporteringBegrensning.build().utenBegrensning());
    ...
    EksporteringServiceTestUtils.assertEqualsSykefraværMedKategori(
        virksomhetSykefraværMedKategori, sykefraværMedKategoriArgumentCaptor.getValue());
    assertThat(antallEksporterte).isEqualTo(1);
  }

  @Test
  public void
      eksporterSykefraværsstatistikkVirksomhet__returnerer_korrekt_antall_meldinger_sendt() {
    List<SykefraværsstatistikkVirksomhetUtenVarighet> allData =
        List.of(
            sykefraværsstatistikkVirksomhet(__2020_2, "987654321"),
            sykefraværsstatistikkVirksomhet(__2020_1, "987654321"),
        ...
        .thenReturn(
            Arrays.asList(
                new VirksomhetEksportPerKvartal(
                    new Orgnr("987654321"), new ÅrstallOgKvartal(2022, 2), false),
                new VirksomhetEksportPerKvartal(
                    new Orgnr("987654322"), new ÅrstallOgKvartal(2022, 2), false)));
  ...
  @Test
  public void
      eksporterSykefraværsstatistikkVirksomhet__eksporterer_til_og_med_bedrifter_uten_statistikk() {
    List<SykefraværsstatistikkVirksomhetUtenVarighet> allData =
        List.of(
            sykefraværsstatistikkVirksomhet(__2020_2, "987654321"),
            sykefraværsstatistikkVirksomhet(__2020_1, "987654321"));
    ...
    when(eksporteringRepository.hentVirksomhetEksportPerKvartal(__2020_2))
        .thenReturn(
            Arrays.asList(
                new VirksomhetEksportPerKvartal(
                    new Orgnr("987654321"), new ÅrstallOgKvartal(2020, 2), false),
                new VirksomhetEksportPerKvartal(
                    new Orgnr("987654322"), new ÅrstallOgKvartal(2020, 2), false)));
  ...
  @Test
  public void
      eksporterSykefraværsstatistikkNæring__sender_riktig_melding_til_kafka_og_returnerer_antall_meldinger_sendt() {
    // 1- Mock det database og repositories returnerer. Samme med KafkaService
    List<SykefraværsstatistikkNæring> allData =
        List.of(
    ...
    when(sykefraværsstatistikkTilEksporteringRepository.hentSykefraværAlleNæringerFraOgMed(any()))
        .thenReturn(allData);
    when(kafkaService.sendTilStatistikkKategoriTopic(any(), any(), any(), any(), any()))
        .thenReturn(true);
    ...
    EksporteringServiceTestUtils.assertEqualsSykefraværMedKategori(
        næringSykefravær, sykefraværMedKategoriArgumentCaptor.getValue());
    assertThat(antallEksporterte).isEqualTo(1);
  }
