...
public class SykefraværRepositoryJdbcTest {
  ...
  static final Bransje BARNEHAGEBRANSJEN =
      new Bransje(ArbeidsmiljøportalenBransje.BARNEHAGER, "Barnehage", "88911");
  ...
  @Test
  public void
      hentSykefraværprosentVirksomhet__skal_returnerer_empty_list_dersom_ingen_data_funnet_for_årstall_og_kvartal() {
    persisterDatasetIDb(BARNEHAGE);

    List<UmaskertSykefraværForEttKvartal> resultat =
        sykefraværRepository.hentUmaskertSykefravær(BARNEHAGE, new ÅrstallOgKvartal(2021, 4));
  ...
  public void hentSykefraværprosentVirksomhet__skal_returnere_riktig_sykefravær() {
    ...
    List<UmaskertSykefraværForEttKvartal> resultat =
        sykefraværRepository.hentUmaskertSykefravær(BARNEHAGE, new ÅrstallOgKvartal(2018, 3));
  ...
  @Test
  public void
      hentSykefraværprosentVirksomhet__skal_returnere_riktig_sykefravær_for_ønskede_kvartaler() {
    persisterDatasetIDb(BARNEHAGE);

    List<UmaskertSykefraværForEttKvartal> resultat =
        sykefraværRepository.hentUmaskertSykefravær(BARNEHAGE, new ÅrstallOgKvartal(2019, 1));
    assertThat(resultat.size()).isEqualTo(2);
  ...
  void hentUmaskertSykefravær_skal_hente_riktig_data_for_5sifferBransje() {
    ...
    List<UmaskertSykefraværForEttKvartal> resultat =
        sykefraværRepository.hentUmaskertSykefravær(
            BARNEHAGEBRANSJEN, new ÅrstallOgKvartal(2019, 1));
    assertThat(resultat.size()).isEqualTo(2);
    assertThat(resultat.get(0)).isEqualTo(sykefraværForEtÅrstallOgKvartal(2019, 1, 3));
    assertThat(resultat.get(1)).isEqualTo(sykefraværForEtÅrstallOgKvartal(2019, 2, 2));
  }
  ...
  private static UmaskertSykefraværForEttKvartal sykefraværForEtÅrstallOgKvartal(
      int årstall, int kvartal, int totalTapteDagsverk) {
