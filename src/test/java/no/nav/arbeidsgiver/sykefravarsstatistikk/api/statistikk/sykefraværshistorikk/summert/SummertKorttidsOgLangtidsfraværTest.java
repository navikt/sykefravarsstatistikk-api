...
class SummertKorttidsOgLangtidsfraværTest {
  ...
  @Test
  public void
      getSummertKorttidsOgLangtidsfravær__skal_returnere_et_tomt_KorttidsOgLangtidsfraværSiste4Kvartaler_dersom_ingen_data_er_tilgjengelig() {
    SummertKorttidsOgLangtidsfravær summertKorttidsOgLangtidsfravær =
        SummertKorttidsOgLangtidsfravær.getSummertKorttidsOgLangtidsfravær(
            new ÅrstallOgKvartal(2020, 1), 4, Arrays.asList());
  ...
  public void getSummertKorttidsOgLangtidsfravær____skal_returnere_langtid_og_korttid_historikk() {
    List<UmaskertSykefraværForEttKvartalMedVarighet> sykefraværMed1Kvartal =
        Arrays.asList(
            getSykefraværMedVarighet(
                sistePublisertÅrstallOgKvartal, 5, 0, 0, Varighetskategori._1_DAG_TIL_7_DAGER),
            getSykefraværMedVarighet(
                sistePublisertÅrstallOgKvartal, 2, 0, 0, Varighetskategori.MER_ENN_39_UKER),
            getSykefraværMedVarighet(
                sistePublisertÅrstallOgKvartal, 0, 100, 10, Varighetskategori.TOTAL));

    SummertKorttidsOgLangtidsfravær summertKorttidsOgLangtidsfravær =
        SummertKorttidsOgLangtidsfravær.getSummertKorttidsOgLangtidsfravær(
            new ÅrstallOgKvartal(2020, 1), 4, sykefraværMed1Kvartal);
  ...
  @Test
  public void
      hentKorttidsOgLangtidsfraværSiste4Kvartaler__skal_returnere_langtid_og_korttid_historikk_for_flere_kvartaler() {
    ÅrstallOgKvartal kvartal1 = new ÅrstallOgKvartal(2019, 4);
    ÅrstallOgKvartal kvartal2 = new ÅrstallOgKvartal(2020, 1);

    List<UmaskertSykefraværForEttKvartalMedVarighet> sykefraværMed2Kvartaler =
        Arrays.asList(
    ...
    SummertKorttidsOgLangtidsfravær summertKorttidsOgLangtidsfravær =
        SummertKorttidsOgLangtidsfravær.getSummertKorttidsOgLangtidsfravær(
            new ÅrstallOgKvartal(2020, 1), 4, sykefraværMed2Kvartaler);
  ...
  @Test
  public void
      hentKorttidsOgLangtidsfraværSiste4Kvartaler__skal_summere_opp_riktig_hvis_det_er_flere_innslag_med_samme_varighet_i_hvert_kvartal() {
  ...
  @Test
  public void
      hentKorttidsOgLangtidsfraværSiste4Kvartaler__filtrerer_bort_kvartaler_som_er_eldre_enn_de_4_siste() {
    ...
    List<UmaskertSykefraværForEttKvartalMedVarighet> umaskertKvartalsvisSykefraværMedVarighet =
        Arrays.asList(
            getSykefraværMedVarighet(
                utdatertKvartal, 10, 0, 0, Varighetskategori._1_DAG_TIL_7_DAGER),
            ...
            getSykefraværMedVarighet(
                ikkeUtdatertKvartal, 10, 0, 0, Varighetskategori._1_DAG_TIL_7_DAGER),
            getSykefraværMedVarighet(
                ikkeUtdatertKvartal, 20, 0, 0, Varighetskategori.MER_ENN_39_UKER),
            getSykefraværMedVarighet(ikkeUtdatertKvartal, 0, 100, 200, Varighetskategori.TOTAL));

    SummertKorttidsOgLangtidsfravær summertKorttidsOgLangtidsfravær =
        SummertKorttidsOgLangtidsfravær.getSummertKorttidsOgLangtidsfravær(
            new ÅrstallOgKvartal(2020, 1), 4, umaskertKvartalsvisSykefraværMedVarighet);
  ...
  @Test
  public void
      hentKorttidsOgLangtidsfraværSiste4Kvartaler__beregner_sykefravær_selv_om_det_bare_er_data_om_TOTAL() {
    ÅrstallOgKvartal sistePublisertKvartal = new ÅrstallOgKvartal(2020, 1);
    ...
    List<UmaskertSykefraværForEttKvartalMedVarighet> umaskertKvartalsvisSykefraværMedVarighet =
        Arrays.asList(
            ...
            getSykefraværMedVarighet(
                kvartalMedKorttidOgLangtidsfravær, 10, 0, 0, Varighetskategori._1_DAG_TIL_7_DAGER),
            getSykefraværMedVarighet(
                kvartalMedKorttidOgLangtidsfravær, 30, 0, 0, Varighetskategori.MER_ENN_39_UKER),
            getSykefraværMedVarighet(
                kvartalMedKorttidOgLangtidsfravær, 0, 100, 200, Varighetskategori.TOTAL));
    ...
    assertIsEqual(
        ...
        false,
        kvartalMedBareTotal,
        kvartalMedKorttidOgLangtidsfravær);
  ...
  @Test
  public void
      hentKorttidsOgLangtidsfraværSiste4Kvartaler__håndterer_kvartaler_som_ikke_inneholder_TOTAL() {
    ÅrstallOgKvartal sistePublisertKvartal = new ÅrstallOgKvartal(2020, 1);
    ...
    List<UmaskertSykefraværForEttKvartalMedVarighet> umaskertKvartalsvisSykefraværMedVarighet =
        Arrays.asList(
            getSykefraværMedVarighet(
                kvartalSomIkkeInneholderTotal, 10, 0, 0, Varighetskategori._1_DAG_TIL_7_DAGER),
            getSykefraværMedVarighet(
                kvartalMedKorttidOgLangtidsfravær, 10, 0, 0, Varighetskategori._1_DAG_TIL_7_DAGER),
            getSykefraværMedVarighet(
                kvartalMedKorttidOgLangtidsfravær, 30, 0, 0, Varighetskategori.MER_ENN_39_UKER),
  ...
  @Test
  public void
      hentKorttidsOgLangtidsfraværSiste4Kvartaler__maskerer_sykefravær_dersom_antall_personer_er_lavere_enn_5() {
    ÅrstallOgKvartal sistePublisertKvartal = new ÅrstallOgKvartal(2020, 1);
    ...
    assertIsMaskert(summertKorttidsOgLangtidsfravær.getSummertKorttidsfravær(), kvartal1, kvartal2);

    assertIsMaskert(summertKorttidsOgLangtidsfravær.getSummertLangtidsfravær(), kvartal1, kvartal2);
  }

  @Test
  public void
      hentKorttidsOgLangtidsfraværSiste4Kvartaler__skal_IKKE_maskere_dersom_maks_antall_personer_er_større_enn_4() {
    ÅrstallOgKvartal kvartal1 = new ÅrstallOgKvartal(2019, 4);
    ÅrstallOgKvartal kvartal2 = new ÅrstallOgKvartal(2020, 1);
  ...
  private void assertIsEqual(
    ...
    assertBigDecimalIsEqual(
        korttidsEllerLangtidsfraværSiste4Kvartaler.getMuligeDagsverk(), expectedMuligeDagsverk);
    assertBigDecimalIsEqual(
        korttidsEllerLangtidsfraværSiste4Kvartaler.getTapteDagsverk(), expectedTapteDagsverk);
    assertBigDecimalIsEqual(
        korttidsEllerLangtidsfraværSiste4Kvartaler.getProsent(), expectedProsent);
    assertThat(korttidsEllerLangtidsfraværSiste4Kvartaler.isErMaskert())
        .isEqualTo(expectedErMaskert);

    kvartalerIsEqual(korttidsEllerLangtidsfraværSiste4Kvartaler, expectedKvartaler);
  }

  private void kvartalerIsEqual(
      SummertSykefravær korttidsEllerLangtidsfraværSiste4Kvartaler,
      ÅrstallOgKvartal[] expectedKvartaler) {
