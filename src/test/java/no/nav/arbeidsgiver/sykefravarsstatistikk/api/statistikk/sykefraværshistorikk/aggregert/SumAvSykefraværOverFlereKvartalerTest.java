...
class SumAvSykefraværOverFlereKvartalerTest {
    ...
    void leggSammenToKvartaler() {
        ...
        UmaskertSykefraværForEttKvartal umaskertSykefravær_Q1 = new UmaskertSykefraværForEttKvartal(
                new ÅrstallOgKvartal(2022, 1),
                new BigDecimal(100),
                new BigDecimal(200),
                5);
        UmaskertSykefraværForEttKvartal umaskertSykefravær_Q2 = new UmaskertSykefraværForEttKvartal(
                new ÅrstallOgKvartal(2022, 2),
                new BigDecimal(10),
                new BigDecimal(230),
                5);

        SykefraværOverFlereKvartaler expected = new SykefraværOverFlereKvartaler(
                List.of(umaskertSykefravær_Q1.getÅrstallOgKvartal(), umaskertSykefravær_Q2.getÅrstallOgKvartal()),
                new BigDecimal(110),
                new BigDecimal(430),
                List.of(
        ...
        SumAvSykefraværOverFlereKvartaler kvartal1 = new SumAvSykefraværOverFlereKvartaler(
                umaskertSykefravær_Q1
        );
        SumAvSykefraværOverFlereKvartaler kvartal2 = new SumAvSykefraværOverFlereKvartaler(
                umaskertSykefravær_Q2
        );
        ...
        Assertions.assertThat(result.muligeDagsverk)
                .isEqualByComparingTo(new BigDecimal(430));
        Assertions.assertThat(result.tapteDagsverk)
