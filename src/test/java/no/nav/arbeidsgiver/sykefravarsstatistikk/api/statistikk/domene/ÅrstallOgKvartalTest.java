...
public class ÅrstallOgKvartalTest {
    ...
    public void minusKvartaler__skal_retunere_rikitg() {
        ...
        assertThat(new ÅrstallOgKvartal(2019, 3).minusKvartaler(0)).isEqualTo(new ÅrstallOgKvartal(2019, 3));
        ...
        assertThat(new ÅrstallOgKvartal(2019, 3).minusKvartaler(-1)).isEqualTo(new ÅrstallOgKvartal(2019, 4));
    }

    @Test
    public void plussKvartaler__skal_retunere_rikitg() {
        assertThat(new ÅrstallOgKvartal(2019, 3).plussKvartaler(1)).isEqualTo(new ÅrstallOgKvartal(2019, 4));
        assertThat(new ÅrstallOgKvartal(2019, 3).plussKvartaler(0)).isEqualTo(new ÅrstallOgKvartal(2019, 3));
        assertThat(new ÅrstallOgKvartal(2019, 4).plussKvartaler(1)).isEqualTo(new ÅrstallOgKvartal(2020, 1));
        assertThat(new ÅrstallOgKvartal(2019, 1).plussKvartaler(1)).isEqualTo(new ÅrstallOgKvartal(2019, 2));
        assertThat(new ÅrstallOgKvartal(2019, 3).plussKvartaler(3)).isEqualTo(new ÅrstallOgKvartal(2020, 2));
        assertThat(new ÅrstallOgKvartal(2019, 3).plussKvartaler(11)).isEqualTo(new ÅrstallOgKvartal(2022, 2));
        assertThat(new ÅrstallOgKvartal(2019, 3).plussKvartaler(-1)).isEqualTo(new ÅrstallOgKvartal(2019, 2));
    }
