...
public class SykefraværForEttKvartalTest {
  ...
  public void sykefraværprosent__equals_test() {
    ...
    assertThat(
            (new SykefraværForEttKvartal(etÅrstallOgKvartal(), null, null, 4).equals(sykefravær)))
        .isEqualTo(false);

    assertThat(sykefravær.equals(new SykefraværForEttKvartal(etÅrstallOgKvartal(), null, null, 4)))
        .isFalse();
  }
                ...
                new SykefraværFlereKvartalerForEksport(
                    List.of(
                        new UmaskertSykefraværForEttKvartal(
                            etÅrstallOgKvartal(), new BigDecimal(10), new BigDecimal(100), 6),
                        new UmaskertSykefraværForEttKvartal(
  ...
  public void sykefraværprosent__skal_runde_prosenten_opp_ved_tvil() {
    SykefraværForEttKvartal sykefravær =
        new SykefraværForEttKvartal(
            etÅrstallOgKvartal(), new BigDecimal(455), new BigDecimal(10000), 100);
