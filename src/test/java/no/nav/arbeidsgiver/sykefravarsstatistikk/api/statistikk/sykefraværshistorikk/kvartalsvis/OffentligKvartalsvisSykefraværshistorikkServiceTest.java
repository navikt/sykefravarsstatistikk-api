...
class OffentligKvartalsvisSykefraværshistorikkServiceTest {
    ...
    @Test
    void hentSykefraværshistorikkV1_offentlig_skal_ikke_feile_dersom_uthenting_av_en_type_data_feiler() {
    ...
    @Test
    public void hentSykefraværshistorikk__skal_returnere_en_bransje_dersom_virksomhet_er_i_bransjeprogram_på_5_siffer_nivå() {
        Underenhet underenhet = Underenhet.builder()
                .orgnr(etOrgnr())
                .overordnetEnhetOrgnr(etOrgnr())
                .navn("Underenhet AS")
        ...
        assertThatHistorikkHarKategori(kvartalsvisSykefraværshistorikk, Statistikkategori.NÆRING, false);
        assertThatHistorikkHarKategori(kvartalsvisSykefraværshistorikk, Statistikkategori.LAND, true);
        assertThatHistorikkHarKategori(kvartalsvisSykefraværshistorikk, Statistikkategori.BRANSJE, true);
    }
