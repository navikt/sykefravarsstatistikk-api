...
@Component
public class GradertRepository {

    private final NamedParameterJdbcTemplate namedParameterJdbcTemplate;

    public GradertRepository(@Qualifier("sykefravarsstatistikkJdbcTemplate") NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
    ...
    public List<UmaskertSykefraværForEttKvartal> hentGradertSykefraværForEttKvartal(Virksomhet virksomhet) {
        try {
            return namedParameterJdbcTemplate.query(
                    "select tapte_dagsverk, mulige_dagsverk, antall_personer, varighet, arstall, kvartal " +
