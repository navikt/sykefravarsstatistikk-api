...
public class EksporteringRepository {
  ...
  public EksporteringRepository(
      @Qualifier("sykefravarsstatistikkJdbcTemplate")
          NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
    this.namedParameterJdbcTemplate = namedParameterJdbcTemplate;
  }

  public int opprettEksport(List<VirksomhetEksportPerKvartal> virksomhetEksportPerKvartalList) {
    if (virksomhetEksportPerKvartalList == null || virksomhetEksportPerKvartalList.isEmpty()) {
      return 0;
    }
    SqlParameterSource[] batch =
        SqlParameterSourceUtils.createBatch(virksomhetEksportPerKvartalList.toArray());
  ...
  public List<VirksomhetEksportPerKvartal> hentVirksomhetEksportPerKvartal(
  ...
  public int batchOpprettVirksomheterBekreftetEksportert(
      List<String> virksomheterSomErBekreftetEksportert, ÅrstallOgKvartal årstallOgKvartal) {

    List<BatchUpdateVirksomhetTilEksport> virksomheter =
        virksomheterSomErBekreftetEksportert.stream()
            .map(
                orgnr ->
                    new BatchUpdateVirksomhetTilEksport(
                        orgnr,
  ...
  public int oppdaterAlleVirksomheterIEksportTabellSomErBekrreftetEksportert() {
    SqlParameterSource parametre =
        new MapSqlParameterSource().addValue("oppdatert", LocalDateTime.now());
  ...
  public int hentAntallIkkeFerdigEksportert() {
    SqlParameterSource parametre = new MapSqlParameterSource().addValue("eksportert", false);
  ...
  public int slettEksportertPerKvartal() {
    SqlParameterSource parametre = new MapSqlParameterSource();
  ...
  private static class BatchUpdateVirksomhetTilEksport {
    ...
    public BatchUpdateVirksomhetTilEksport(
        String orgnr, int årstall, int kvartal, boolean eksportert, LocalDateTime oppdatert) {
      this.orgnr = orgnr;
