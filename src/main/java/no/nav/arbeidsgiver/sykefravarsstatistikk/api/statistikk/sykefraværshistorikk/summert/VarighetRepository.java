...
public class VarighetRepository {
    ...
    public Map<Statistikkategori, List<UmaskertSykefraværForEttKvartalMedVarighet>> hentUmaskertSykefraværMedVarighetAlleKategorier(
        ...
        data.put(VIRKSOMHET,
              hentSykefraværForEttKvartalMedVarighet(virksomhet));
