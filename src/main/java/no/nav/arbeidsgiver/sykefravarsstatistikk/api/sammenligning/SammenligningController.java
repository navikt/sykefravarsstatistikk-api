...
import static no.nav.arbeidsgiver.sykefravarsstatistikk.api.sammenligning.CookieUtils.hentCookieEllerGenererNy;
...
public class SammenligningController {
    ...
    public Sammenligning sammenligning(
        ...
        String sessionId = CookieUtils.hentCookieEllerGenererNy(request, response, SESSION_ID_COOKIE_NAME);
