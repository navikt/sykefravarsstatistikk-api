...
public class SykefraværshistorikkController {
    ...
    public static final ÅrstallOgKvartal SISTE_PUBLISERTE_ÅRSTALL_OG_KVARTAL = new ÅrstallOgKvartal(2021, 4);
    ...
    public ResponseEntity<LegemeldtSykefraværsprosent> hentLegemeldtSykefraværsprosent(
        ...
        boolean brukerHarIARettighet = false;
        InnloggetBruker bruker = tilgangskontrollService.hentInnloggetBrukerForAlleRettigheter();
        brukerHarIARettighet = tilgangskontrollService.sjekkTilgangTilOrgnrOgLoggSikkerhetshendelse(
                new Orgnr(orgnrStr),
                bruker,
                request.getMethod(),
                "" + request.getRequestURL()
        ...
        try {
            bruker = tilgangskontrollService.hentInnloggetBruker();
            brukerHarIARettighet = tilgangskontrollService.sjekkTilgangTilOrgnrOgLoggSikkerhetshendelse(
                    new Orgnr(orgnrStr),
                    bruker,
                    request.getMethod(),
        ...
        } catch (TilgangskontrollException ignored) {
