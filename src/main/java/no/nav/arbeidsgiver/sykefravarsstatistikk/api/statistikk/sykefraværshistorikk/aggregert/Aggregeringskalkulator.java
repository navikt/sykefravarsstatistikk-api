...
public class Aggregeringskalkulator {
  ...
  public Aggregeringskalkulator(Sykefraværsdata sykefraværsdata) {
  ...
  public Either<StatistikkException, SykefraværOverFlereKvartaler> getSykefraværForFlereKvartaler(
    ...
    return sumAvSykefraværOverFlereKvartaler.regnUtProsentOgMapTilSykefraværForFlereKvartaler();
  }
  ...
  public Either<StatistikkException, StatistikkDto> fraværsprosentBransjeEllerNæring(
    ...
    return summerOppSisteFireKvartaler(
        ...
        .regnUtProsentOgMapTilDto(
            bransjeEllerNæring.getStatistikkategori(), bransjeEllerNæring.navn());
  }
  ...
  public Either<StatistikkException, StatistikkDto> fraværsprosentVirksomhet(
  ...
  private List<UmaskertSykefraværForEttKvartal> ekstraherSisteFireKvartaler(
    ...
    return statistikk.stream()
        .filter(
            datapunkt ->
                ÅrstallOgKvartal.sisteFireKvartaler(this.sistePubliserteKvartal)
