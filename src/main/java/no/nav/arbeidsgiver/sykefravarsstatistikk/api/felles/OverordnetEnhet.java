...
public class OverordnetEnhet implements Virksomhet {
  @NotNull private final Orgnr orgnr;
  @NotNull private final String navn;
  @NotNull private final Næringskode5Siffer næringskode;
  @NotNull private final InstitusjonellSektorkode institusjonellSektorkode;
