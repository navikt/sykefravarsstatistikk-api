...
public class TokenXClient {
  ...
  public TokenXClient(
      @Value("${tokenxclient.jwk}") String tokenxJwk,
      @Value("${tokenxclient.clientId}") String tokenxClientId,
      @Value("${tokenxclient.altinn_rettigheter_proxy_audience}")
          String altinnRettigheterProxyAudience,
  ...
  public JwtToken exchangeTokenToAltinnProxy(JwtToken token)
    ...
    AuthorizationServerMetadata authorizationServerMetadata =
        resolveUrlAndGetAuthorizationServerMetadata(tokenxWellKnownUrl);
    ...
    HttpEntity<MultiValueMap<String, String>> tokenExchangeRequestHttpEntity =
        new HttpEntity<>(parametre, httpHeaders);
  ...
  protected AuthorizationServerMetadata resolveUrlAndGetAuthorizationServerMetadata(
      String wellKnownUrl) throws GeneralException, IOException {
    String trimmetUrl = trimUrl(wellKnownUrl);
    AuthorizationServerMetadata authorizationServerMetadata =
        AuthorizationServerMetadata.resolve(new Issuer(trimmetUrl));
  ...
  @NotNull
  public static String trimUrl(String tokenxWellKnownUrl) {
